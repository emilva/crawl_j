...
@Mojo( name = "nuxeo", defaultPhase = LifecyclePhase.PROCESS_SOURCES )
public class NuxeoMojo extends CentralMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        try{
            ...
            mavenRepository = mavenRepositoryDao.findByName("nuxeo");
            MavenRepository publicNuxeoRepo = mavenRepositoryDao.findByName("nuxeo-public-releases");
